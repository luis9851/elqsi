...
<div class="container">
  <h1>COMO SUBIR SU PAGINA WEB A HEROKU </h1>
    ...
    <h2>4.-Despues ingrasamos en el apartado de variables de entorno y creamos 2 nuevas variables de sistema; una llamada JAVA_HOME con la direccion C:\Program Files\Java\jdk1.8.0_181 y la otra se llamara MAVEN_HOME con direccion C:\Program Files\apache-maven-3.6.0\bin</h2>
        <img src="C:\Users\loera\Desktop\marketful\variables.png"      
         width="600"
         height="390">
        <img src="C:\Users\loera\Desktop\marketful\JAVA_HOME.png"
         width="600"
         height="390">
        <img src="C:\Users\loera\Desktop\marketful\MAVEN_HOME.png"      
         width="600"
         height="390">
